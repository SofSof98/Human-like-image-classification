...
# ViT
model_ft = vit_b_16(weights=ViT_B_16_Weights.IMAGENET1K_V1)
...
print(num_ftrs)
model_ft.heads.head = torch.nn.Linear(num_ftrs,10)
...
model_ft = train_model(dataloaders, dataset_sizes, model_ft, criterion, optimizer_ft, exp_lr_scheduler, model_path, num_epochs=20)
